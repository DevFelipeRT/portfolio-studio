...
use App\Modules\Skills\Application\UseCases\DeleteSkillCategoryTranslation\DeleteSkillCategoryTranslationInput;
use App\Modules\Skills\Application\UseCases\ListSkillCategoryTranslations\ListSkillCategoryTranslations;
use App\Modules\Skills\Application\UseCases\ListSkillCategoryTranslations\ListSkillCategoryTranslationsInput;
...
final class SkillCategoryTranslationController extends Controller
{
    ...
    {
        $items = $this->listSkillCategoryTranslations->handle(
            new ListSkillCategoryTranslationsInput(
                skillCategoryId: $skillCategory->id,
            ),
        );

        return response()->json(
            $this->skillTranslationJsonPresenter->presentCategoryList($items),
        );
    }
    ...
    public function store(
        ...
        return response()->json(
            $this->skillTranslationJsonPresenter->presentCreatedCategoryTranslation(
                $dto,
            ),
            201,
        );
    ...
    public function update(
        ...
        return response()->json(
            $this->skillTranslationJsonPresenter->presentUpdatedCategoryTranslation(
                $dto,
            ),
        );
    }
    ...
    {
        $this->deleteSkillCategoryTranslation->handle(
            new DeleteSkillCategoryTranslationInput(
                skillCategoryId: $skillCategory->id,
                locale: $locale,
            ),
        );
