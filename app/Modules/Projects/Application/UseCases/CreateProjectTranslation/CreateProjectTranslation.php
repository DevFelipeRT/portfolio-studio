...
final class CreateProjectTranslation
{
    ...
    public function handle(CreateProjectTranslationInput $input): CreateProjectTranslationOutput
    {
        ...
        if ($existing !== null) {
            throw ValidationException::withMessages([
                'locale' => ['Project translation already exists for this locale.'],
            ]);
        }
        ...
        return $this->projectTranslationOutputMapper->toCreateOutput($translation);
    }
