    ...
    return (
        <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-1.5">
                <Label htmlFor="edit-section-navigation-label">Navigation label</Label>
                <Input
            ...
            <div className="space-y-1.5">
                <Label htmlFor="edit-section-navigation-group">Navigation group</Label>
                <SelectableInput
                    id="edit-section-navigation-group"
                    value={navigationGroup}
                    onChange={onNavigationGroupChange}
                    placeholder="About"
                    options={navigationGroups.map((group) => ({ value: group }))}
