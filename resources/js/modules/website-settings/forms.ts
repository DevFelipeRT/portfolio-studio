...
} from '@/modules/website-settings/types';
...
export const buildWebsiteSettingsFormData = (
  ...
  return {
    ...
    site_description: ensureLocaleMap(settings.site_description, localeList),
    ...
    robots: {
      ...
      private: {
        ...
        follow:
          settings.robots?.private?.follow ?? defaultRobots.private.follow,
      },
    },
    system_pages: {
      ...defaultSystemPages,
