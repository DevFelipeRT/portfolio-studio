  ...
  return (
    <div className="flex items-center md:hidden">
      <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
        ...
        <SheetContent
          side="left"
          className="bg-background/80 supports-backdrop-filter:bg-background/60 flex w-fit flex-col gap-4 p-0 pt-12 backdrop-blur-sm"
        >
            ...
            {items.map((item) => {
              ...
              if (isSectionItem(item)) {
                ...
                return (
                  <div
                    key={item.id}
                    className={mobileWrapperClass(isActiveSection)}
                  >
                    <Button
                      type="button"
                      variant="ghost"
